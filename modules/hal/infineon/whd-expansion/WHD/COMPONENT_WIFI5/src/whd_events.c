                                              ...
                                              void *handler_user_data, uint16_t *event_index)
{
    ...
    {
        /*
         * AP6212 firmware on ART-Pi can reject blanket event_msgs programming
         * even when the control path remains usable for scan/join. Preserve
         * the local handler registration and continue.
         */
